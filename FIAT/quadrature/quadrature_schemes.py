...
def _triangle_scheme(degree):
    ...
    if degree == 0 or degree == 1:
        ...
        x = np.array([[0.33333333333333333, 0.33333333333333333],
        ...
        w = np.arange(7, dtype=np.float64)
        ...
        x = np.array([[0.873821971016996, 0.063089014491502],
...
def _tetrahedron_scheme(degree):
    ...
    if degree == 0 or degree == 1:
        ...
        x = np.array([[0.2500000000000000, 0.2500000000000000, 0.2500000000000000],
        ...
        # (KEAST5)
        x = np.array([[0.0000000000000000, 0.5000000000000000, 0.5000000000000000],
        ...
        w = np.arange(15, dtype=np.float64)
        ...
        # Values taken from http://people.sc.fsu.edu/~jburkardt/datasets/quadrature_rules_tet/quadrature_rules_tet.html
        # (KEAST7)
        x = np.array([[0.3561913862225449, 0.2146028712591517, 0.2146028712591517],
        ...
        w = np.arange(24, dtype=np.float64)
